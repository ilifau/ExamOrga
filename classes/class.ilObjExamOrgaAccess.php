 ...
 */
class ilObjExamOrgaAccess extends ilObjectPluginAccess
{
	/**
	 ...
	 */
	function _checkAccess(string $a_cmd, string $a_permission, int $a_ref_id, int $a_obj_id, int|null $a_user_id = 0): bool
	{
	    global $DIC;
	...
	static function checkOnline($a_id)
	{
		...
		return (bool) ilExamOrgaData::_lookup($a_id ,'online');
	}
}
